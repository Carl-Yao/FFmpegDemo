////
////  VideoPictureManager.m
////  FFmpegTest
////
////  Created by 姚振兴 on 16/4/26.
...
//
//@implementation VideoPictureManager
//
//#pragma yuv
///**
...
//	FILE *fp1=fopen( [[[[NSBundle mainBundle] resourcePath] stringByAppendingPathComponent:@"output_420_y.y"] UTF8String],"wb+");
//	FILE *fp2=fopen( [[[[NSBundle mainBundle] resourcePath] stringByAppendingPathComponent:@"output_420_u.y"] UTF8String],"wb+");
//	FILE *fp3=fopen( [[[[NSBundle mainBundle] resourcePath] stringByAppendingPathComponent:@"output_420_v.y"] UTF8String],"wb+");
//
...
//    FILE *fp=fopen(url,"rb+");
//    FILE *fp1=fopen([[[[NSBundle mainBundle] resourcePath] stringByAppendingPathComponent:@"output_444_y.y"] UTF8String],"wb+");
//    FILE *fp2=fopen([[[[NSBundle mainBundle] resourcePath] stringByAppendingPathComponent:@"output_444_u.y"] UTF8String],"wb+");
//    FILE *fp3=fopen([[[[NSBundle mainBundle] resourcePath] stringByAppendingPathComponent:@"output_444_v.y"] UTF8String],"wb+");
