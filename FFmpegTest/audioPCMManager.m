...
//
//@implementation audioPCMManager
///**
...
//    FILE *fp1=fopen([[[[NSBundle mainBundle] resourcePath] stringByAppendingPathComponent:@"output_l.pcm"] UTF8String],"wb+");
//    FILE *fp2=fopen([[[[NSBundle mainBundle] resourcePath] stringByAppendingPathComponent:@"output_r.pcm"] UTF8String],"wb+");
//    
